...
**Data:** 49,517 completed internationals (1872-11-30 → 2026-07-15),
2 upcoming fixtures, 47,903 goal events · model `2026.07.16-1`

**Protocol:** fit 1980-01-01 → 2018-12-31
(30,136 matches) · validation 2019-01-01 → 2022-12-31
(3,581) · untouched test 2023-01-01 → 2026-07-15
(3,708) · champion selected fully out-of-sample on validation · Elo tuned to
home_advantage=80, k_scale=0.75

| Model | Val log loss | Test log loss | Test RPS | Test acc. | Test ECE |
|---|---|---|---|---|---|
| frequency_baseline | 1.0459 | 1.0545 | 0.2296 | 47.2% | 0.0119 |
| elo_logistic | 0.8606 | 0.8665 | 0.1689 | 60.4% | 0.0191 |
| poisson | 0.8614 | 0.8674 | 0.1694 | 60.5% | 0.0197 |
| dixon_coles | 0.8606 | 0.8661 | 0.1693 | 60.5% | 0.0158 |
| gbm_uncalibrated | 0.8715 | 0.8716 | 0.1694 | 60.6% | 0.0289 |
| gbm_calibrated | 0.8869 | 0.8659 | 0.1685 | 61.0% | 0.0177 |
| geometric_ensemble ⭐ | 0.8584 | 0.8642 | 0.1686 | 60.2% | 0.0172 |

**Champion (`geometric_ensemble`) on untouched test (n=3,708):** log loss
**0.8642**, RPS **0.1686**, Brier 0.5082, top-pick
accuracy **60.2%**, ECE **0.0172** — best on both validation and test.
