...
**Data:** 49,499 completed internationals (1872-11-30 → 2026-07-07),
4 upcoming fixtures, 47,886 goal events · model `2026.07.07-1`

**Protocol:** fit 1980-01-01 → 2018-12-31
(30,133 matches) · validation 2019-01-01 → 2022-12-31
(3,581) · untouched test 2023-01-01 → 2026-07-07
(3,693) · champion selected on validation log loss · Elo tuned to
home_advantage=80, k_scale=0.75

| Model | Val log loss | Test log loss | Test RPS | Test acc. | Test ECE |
|---|---|---|---|---|---|
| frequency_baseline | 1.0459 | 1.0544 | 0.2294 | 47.2% | 0.0116 |
| elo_logistic | 0.8607 | 0.8669 | 0.1689 | 60.3% | 0.0200 |
| poisson | 0.8614 | 0.8676 | 0.1693 | 60.5% | 0.0201 |
| dixon_coles | 0.8606 | 0.8662 | 0.1692 | 60.5% | 0.0163 |
| gbm_uncalibrated | 0.8712 | 0.8733 | 0.1691 | 60.5% | 0.0256 |
| gbm_calibrated ⭐ | 0.8555 | 0.8701 | 0.1687 | 60.8% | 0.0135 |

**Champion on untouched test (n=3,693):** log loss **0.8701**, RPS **0.1687**,
Brier 0.5105, top-pick accuracy **60.8%**, ECE **0.0135**.
Honest note: Dixon–Coles slightly beats the champion on test (0.8662);
