...
**Data:** 49,495 completed internationals (1872-11-30 → 2026-07-05),
6 upcoming fixtures, 47,875 goal events · model `2026.07.07-1`

**Protocol:** fit 1980-01-01 → 2018-12-31
(30,133 matches) · validation 2019-01-01 → 2022-12-31
(3,581) · untouched test 2023-01-01 → 2026-07-05
(3,689) · champion selected on validation log loss · Elo tuned to
home_advantage=80, k_scale=0.75

| Model | Val log loss | Test log loss | Test RPS | Test acc. | Test ECE |
|---|---|---|---|---|---|
| frequency_baseline | 1.0459 | 1.0543 | 0.2293 | 47.2% | 0.0114 |
| elo_logistic | 0.8607 | 0.8669 | 0.1689 | 60.3% | 0.0199 |
| poisson | 0.8614 | 0.8676 | 0.1693 | 60.5% | 0.0205 |
| dixon_coles | 0.8606 | 0.8663 | 0.1692 | 60.5% | 0.0167 |
| gbm_uncalibrated | 0.8712 | 0.8734 | 0.1692 | 60.5% | 0.0255 |
| gbm_calibrated ⭐ | 0.8555 | 0.8701 | 0.1687 | 60.8% | 0.0137 |

**Champion on untouched test (n=3,689):** log loss **0.8701**, RPS **0.1687**,
Brier 0.5106, top-pick accuracy **60.8%**, ECE **0.0137**.
Honest note: Dixon–Coles slightly beats the champion on test (0.8663);
