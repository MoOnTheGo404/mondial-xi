...
**Data:** 49,505 completed internationals (1872-11-30 → 2026-07-15),
2 upcoming fixtures, 47,900 goal events · model `2026.07.15-1`
...
(3,699) · champion selected fully out-of-sample on validation · Elo tuned to
home_advantage=80, k_scale=0.75

| Model | Val log loss | Test log loss | Test RPS | Test acc. | Test ECE |
|---|---|---|---|---|---|
| frequency_baseline | 1.0459 | 1.0544 | 0.2295 | 47.2% | 0.0116 |
| elo_logistic | 0.8607 | 0.8666 | 0.1689 | 60.3% | 0.0194 |
| poisson | 0.8614 | 0.8673 | 0.1693 | 60.5% | 0.0193 |
| dixon_coles | 0.8606 | 0.8660 | 0.1692 | 60.5% | 0.0155 |
| gbm_uncalibrated | 0.8712 | 0.8727 | 0.1690 | 60.6% | 0.0249 |
| gbm_calibrated | 0.8885 | 0.8696 | 0.1686 | 60.9% | 0.0128 |
| geometric_ensemble ⭐ | 0.8585 | 0.8642 | 0.1686 | 60.2% | 0.0171 |

**Champion (`geometric_ensemble`) on untouched test (n=3,699):** log loss
