...
**Data:** 49,501 completed internationals (1872-11-30 → 2026-07-10),
2 upcoming fixtures, 47,888 goal events · model `2026.07.10-1`

**Protocol:** fit 1980-01-01 → 2018-12-31
(30,133 matches) · validation 2019-01-01 → 2022-12-31
(3,581) · untouched test 2023-01-01 → 2026-07-10
(3,695) · champion selected fully out-of-sample on validation · Elo tuned to
home_advantage=80, k_scale=0.75

| Model | Val log loss | Test log loss | Test RPS | Test acc. | Test ECE |
|---|---|---|---|---|---|
| frequency_baseline | 1.0459 | 1.0543 | 0.2294 | 47.3% | 0.0113 |
| elo_logistic | 0.8607 | 0.8667 | 0.1689 | 60.3% | 0.0197 |
| poisson | 0.8614 | 0.8674 | 0.1693 | 60.5% | 0.0198 |
| dixon_coles | 0.8606 | 0.8661 | 0.1691 | 60.5% | 0.0160 |
| gbm_uncalibrated | 0.8712 | 0.8732 | 0.1691 | 60.5% | 0.0254 |
| gbm_calibrated | 0.8885 | 0.8700 | 0.1687 | 60.8% | 0.0132 |
| geometric_ensemble ⭐ | 0.8585 | 0.8643 | 0.1685 | 60.2% | 0.0174 |

**Champion (`geometric_ensemble`) on untouched test (n=3,695):** log loss
**0.8643**, RPS **0.1685**, Brier 0.5083, top-pick
accuracy **60.2%**, ECE **0.0174** — best on both validation and test.
