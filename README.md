...
**Data:** 49,518 completed internationals (1872-11-30 → 2026-07-18),
1 upcoming fixtures, 47,913 goal events · model `2026.07.19-1`

**Protocol:** fit 1980-01-01 → 2018-12-31
(30,136 matches) · validation 2019-01-01 → 2022-12-31
(3,581) · untouched test 2023-01-01 → 2026-07-18
(3,709) · champion selected fully out-of-sample on validation · Elo tuned to
home_advantage=80, k_scale=0.75

| Model | Val log loss | Test log loss | Test RPS | Test acc. | Test ECE |
|---|---|---|---|---|---|
| frequency_baseline | 1.0459 | 1.0546 | 0.2296 | 47.2% | 0.0120 |
| elo_logistic | 0.8606 | 0.8666 | 0.1690 | 60.3% | 0.0192 |
| poisson | 0.8614 | 0.8676 | 0.1694 | 60.5% | 0.0198 |
| dixon_coles | 0.8606 | 0.8663 | 0.1693 | 60.5% | 0.0159 |
| gbm_uncalibrated | 0.8715 | 0.8717 | 0.1694 | 60.6% | 0.0291 |
| gbm_calibrated | 0.8869 | 0.8660 | 0.1686 | 61.0% | 0.0176 |
| geometric_ensemble ⭐ | 0.8584 | 0.8643 | 0.1687 | 60.2% | 0.0173 |

**Champion (`geometric_ensemble`) on untouched test (n=3,709):** log loss
**0.8643**, RPS **0.1687**, Brier 0.5083, top-pick
accuracy **60.2%**, ECE **0.0173** — best on both validation and test.
