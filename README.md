...
4 upcoming fixtures, 47,886 goal events · model `2026.07.09-1`
...
(3,693) · champion selected fully out-of-sample on validation · Elo tuned to
...
| gbm_calibrated | 0.8885 | 0.8701 | 0.1687 | 60.8% | 0.0135 |
| geometric_ensemble ⭐ | 0.8585 | 0.8645 | 0.1686 | 60.2% | 0.0176 |

**Champion (`geometric_ensemble`) on untouched test (n=3,693):** log loss
**0.8645**, RPS **0.1686**, Brier 0.5085, top-pick
accuracy **60.2%**, ECE **0.0176** — best on both validation and test.
