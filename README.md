...
**Data:** 49,504 completed internationals (1872-11-30 → 2026-07-14),
1 upcoming fixtures, 47,898 goal events · model `2026.07.14-1`

**Protocol:** fit 1980-01-01 → 2018-12-31
(30,133 matches) · validation 2019-01-01 → 2022-12-31
(3,581) · untouched test 2023-01-01 → 2026-07-14
(3,698) · champion selected fully out-of-sample on validation · Elo tuned to
home_advantage=80, k_scale=0.75

| Model | Val log loss | Test log loss | Test RPS | Test acc. | Test ECE |
|---|---|---|---|---|---|
| frequency_baseline | 1.0459 | 1.0543 | 0.2294 | 47.2% | 0.0114 |
| elo_logistic | 0.8607 | 0.8666 | 0.1689 | 60.3% | 0.0196 |
| poisson | 0.8614 | 0.8673 | 0.1693 | 60.5% | 0.0195 |
| dixon_coles | 0.8606 | 0.8660 | 0.1692 | 60.5% | 0.0157 |
| gbm_uncalibrated | 0.8712 | 0.8728 | 0.1691 | 60.5% | 0.0250 |
| gbm_calibrated | 0.8885 | 0.8697 | 0.1686 | 60.8% | 0.0129 |
| geometric_ensemble ⭐ | 0.8585 | 0.8642 | 0.1686 | 60.2% | 0.0172 |

**Champion (`geometric_ensemble`) on untouched test (n=3,698):** log loss
**0.8642**, RPS **0.1686**, Brier 0.5083, top-pick
