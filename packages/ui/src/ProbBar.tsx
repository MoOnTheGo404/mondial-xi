 ...
 * home = emerald, draw = neutral slate, away = azure. Segments grow in on
 * mount. Includes a text alternative for screen readers.
 */
  ...
  return (
    <div>
      ...
      <div
        ...
        style={{ height }}
      >
        <div className={`bg-home ${seg}`} style={{ width: pct(probs.home) }} />
        <div className={`bg-ink-500 ${seg}`} style={{ width: pct(probs.draw) }} />
        <div className={`bg-away ${seg}`} style={{ width: pct(probs.away) }} />
      </div>
    </div>
  );
}
